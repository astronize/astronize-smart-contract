...
contract NextTransferRouter is Authorization, INextTransferRouter {
  ...
  function addKToken(address _kToken) external {
  ...
  // onlySuperAdmin removed
  function removeKToken(address _kToken) external {
