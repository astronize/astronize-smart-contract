...
async function main() {
  ...
  const name  = "TSXZODIAC"
  const symbol  = "TSXZODIAC"
  const baseURI = ""
  ...
  const AstronizeAirdropNFTKAP721 = await ethers.getContractFactory("TSXZODIAC"); 
...
nvm use v18.16.0
npx hardhat run ast_nft_kap721_TSXZODIAC.ts --network bitkubMainnet
npx hardhat flatten ../../contracts/astronize/TSXZODIAC.sol > ../../flatten/TSXZODIAC.sol
*/
